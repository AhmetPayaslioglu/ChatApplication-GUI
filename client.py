...
#The client calls the connect() method to connect to a specified socket address (again, in the form of a tuple) of the server.
#If the specified socket is not ready to receive connections (e.g. you did not run the server script yet), the connect() call will fail.
class Client:
    """
...
# I make use of multithreading. This time, it is to let the sending and receiving operations run alongside each other.
